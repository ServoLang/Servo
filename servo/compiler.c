...
static void binary() {
    ...
    switch (operatorType) {
        ...
        break;
        case TOKEN_MOD: emitByte(OP_MODULO);
        break;
        case TOKEN_POW: emitByte(OP_POWER);
        break;
        default:
            return; // unreachable
    }
...
ParseRule rules[] = {
    ...
    [TOKEN_RIGHT_POINTER] = {NULL, NULL, PREC_NONE},
    [TOKEN_LEFT_POINTER] = {NULL, NULL, PREC_NONE},
    [TOKEN_NULL_ASSIGNMENT] = {NULL, NULL, PREC_NONE},
    [TOKEN_NULLISH_ASSIGNMENT] = {NULL, NULL, PREC_NONE},
